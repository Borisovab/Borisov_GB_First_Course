...
class TrunkCar: Car {
    ...
    init(yearOfIssue : YearOfIssue, trunkVolume: Double, filledTrunkSpace : Double, truckTradeMark : TruckTM, engineOperatingCondition : EngineOperatingCondition, fuel: Int) {
